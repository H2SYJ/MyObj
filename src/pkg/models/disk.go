...
type Disk struct {
	...
	Size     int64  `gorm:"type:BIGINT;not null" json:"size"`                                          // 磁盘总大小（字节）
	DiskPath string `gorm:"type:text;not null;index:disk_disk_path_index,length:255" json:"disk_path"` // 磁盘路径
