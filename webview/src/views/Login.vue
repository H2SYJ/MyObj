      ...
      <div class="auth-card">
        ...
        >
          <div class="input-group">
            ...
            <el-input v-model="loginForm.username" :placeholder="t('login.usernamePlaceholder')" class="custom-input" />
          </div>
          <div class="input-group">
            <div class="label-row">
          ...
          <button type="submit" class="submit-btn" :class="{ 'is-loading': loading }">
        ...
        >
          ...
          <div class="input-group">
            ...
            <el-input v-model="registerForm.email" :placeholder="t('login.emailPlaceholder')" class="custom-input" />
          </div>
          <div class="input-group">
        ...
        <div class="auth-switch">
          ...
          <span v-if="activeTab === 'login' && (allowRegister || isFirstUse)" class="switch-link" @click="toggleMode">
            {{ t('login.freeRegister') }}
          </span>
          <span v-else-if="activeTab === 'register'" class="switch-link" @click="toggleMode">
            {{ t('login.backToLogin') }}
          </span>
          <span v-else class="switch-link disabled" @click="toggleMode">
