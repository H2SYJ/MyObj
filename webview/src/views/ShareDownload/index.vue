      ...
      <div v-else-if="shareInfo && shareInfo.file_name" class="share-info-container">
        ...
        <div class="file-info-card">
          <div class="file-icon-wrapper">
            <file-icon :mime-type="shareInfo.mime_type" :file-name="shareInfo.file_name" :icon-size="64" />
          </div>
          ...
          <div class="file-details">
            ...
            <div class="file-meta">
              ...
              <div class="meta-item" v-if="shareInfo.download_count > 0">
                ...
                <span
                  >{{ t('shareDownload.downloadCount') }}：{{ shareInfo.download_count }}
                  {{ t('shareDownload.times') }}</span
                >
              </div>
            </div>
          </div>
...
<script setup lang="ts">
  ...
  const handleDownload = () => {
    ...
    const downloadUrl = getShareDownloadUrl(token.value, shareInfo.value.has_password ? password.value : undefined)
