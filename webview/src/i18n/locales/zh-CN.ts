export default {
  ...
  subscriptions: {
    ...
    modeDaily: '每日时间',
    modeCron: 'Cron 表达式',
    cronPlaceholder: '0 */2 * * * *（秒 分 时 日 月 周），也支持 5 段或 @daily',
    cronInvalid: 'Cron 表达式格式无效，需为 5 或 6 段（或 @daily 等别名）',
    initialLimit: '首次下载',
    runLimit: '单次上限',
  ...
  admin: {
    ...
    permissions: {
      ...
      dict: {
        ...
        'file:tag': { name: '文件标签', description: '维护文件与目录标签' },
