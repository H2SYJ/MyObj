export default {
  ...
  files: {
    ...
    encryptedThumbnailUnsupported: '加密文件不支持缩略图',
    selectAll: '全选',
    cancelSelect: '取消选择',
  ...
  tags: {
    fileTags: '文件标签',
    clearSearch: '清空关键词和标签',
    existingTags: '已有标签',
    loadingSuggestions: '正在加载标签…',
    noMatchingTags: '没有匹配的已有标签',
    manage: '管理标签',
    batchManage: '批量打标',
    manageTitle: '管理标签：{name}',
    batchTitle: '批量管理 {count} 个文件的标签',
    selectFileFirst: '请先选择至少一个文件',
    automatic: '自动标签',
    automaticHint: '关闭标签可将其加入屏蔽列表，重建后也不会重新出现',
    noAutomatic: '暂无自动标签',
    suppressed: '已屏蔽的自动标签',
    suppressedHint: '关闭标签即可恢复并重新生成',
    restore: '恢复',
    manual: '手工标签',
    manualHint: '手工标签不会被自动重建覆盖',
    noManual: '暂无手工标签',
    addManual: '添加标签',
    batchOperation: '批量操作',
    batchAdd: '批量添加',
    batchRemove: '批量删除',
    names: '标签名称',
    namesPlaceholder: '输入标签后按回车，可一次添加多个',
    category: '分类',
    ...
    private: '私有',
    removeTags: '要删除的标签',
    removePlaceholder: '搜索并选择要删除的手工标签',
    inlineAdd: '添加标签',
    inlineAddTitle: '添加文件标签',
    inlineAddPlaceholder: '搜索已有标签或输入新标签',
    inlineNewCategory: '新标签分类',
    removeTag: '删除标签“{name}”',
    suppressTag: '隐藏自动标签“{name}”',
    removeAndSuppress: '删除并隐藏标签“{name}”',
    retryQueued: '已重新加入自动标签生成队列',
    saveSuccess: '标签已保存',
    saveFailed: '标签保存失败',
    loadFailed: '标签加载失败',
    preview: '预览',
  ...
  offline: {
    ...
    requestHeaders: '请求头',
    newHLSURL: '新 m3u8 地址',
    newHLSURLOptional: '可选，已有快照时留空继续使用',
    newHLSURLTip: '填写后会先抓取完整子级清单和密钥；失败或取消任务的快照已清理时需要填写。',
  ...
  settings: {
    ...
    tagDictionary: {
      title: '个人分词词典',
      navDescription: '维护自定义词、停用词和别名',
      description: '个人规则优先于全局强制词和别名，停用词会与全局规则合并。保存后立即热更新并重建你的历史文件。',
      ruleCount: '共 {count} 条规则',
      previewTitle: '文件名批量预览',
      previewDescription: '预览只验证当前编辑内容，不会保存或触发重建',
      samplePlaceholder: '每行一个文件名，最多 100 行',
      rebuildQueued: '个人词典已发布，已排队重建 {total} 个文件',
      patternRequired: '规则匹配内容不能为空',
      aliasRequired: '别名规则必须填写输出内容',
      sampleRequired: '请至少输入一个预览文件名',
      loadFailed: '个人词典加载失败',
      saveSuccess: '个人词典已热更新',
      saveFailed: '个人词典保存失败',
      previewFailed: '词典预览失败'
    },
  ...
  admin: {
    ...
    nav: {
      ...
      tags: '维护自动标签分类、规则版本与重建任务'
    },
    tags: {
      title: '标签与词典',
      description: '管理全局自动标签规则、热部署版本、元数据 Provider 和历史重建任务',
      degraded: '活动规则加载失败，当前正在使用内置基础规则',
      autoEnabled: '自动 Tag',
      autoLimit: '每文件自动 Tag 上限',
      activeVersion: '活动版本',
      providers: '元数据 Provider',
      categories: '标签分类',
      addCategory: '新增分类',
      editCategory: '编辑分类',
      categoryCode: '分类代码',
      ...
      draftEditor: '规则草稿',
      noDraft: '当前没有规则草稿',
      createDraft: '从活动版本创建草稿',
      targetField: '目标字段',
      publish: '发布并热部署',
      previewTitle: '多样例预览',
      previewDescription: '使用当前未保存草稿编译候选快照并生成标签',
      samplePlaceholder: '每行一个文件名，最多 100 行',
      versions: '版本历史',
      basedOn: '基于版本',
      publishedAt: '发布时间',
      ...
      baseVersion: '基础版本',
      targetVersion: '目标版本',
      loadFailed: '标签管理数据加载失败',
      settingsSaved: '自动标签设置已保存',
      deleteCategoryConfirm: '确定删除标签分类“{name}”吗？',
      patternRequired: '所有规则都必须填写匹配内容',
      aliasRequired: '别名规则必须填写输出内容',
      sampleRequired: '请至少输入一个预览文件名',
      draftSaved: '规则草稿已保存',
      publishConfirm: '确定发布全局规则 v{version} 吗？发布后会立即热切换并启动历史重建。',
      publishSuccess: '全局规则 v{version} 已发布并热部署',
      importSuccess: '词典已导入草稿',
      importFailed: '词典导入失败',
      exportFailed: '词典导出失败',
      rollbackConfirm: '确定复制 v{version} 的内容并发布为新版本吗？'
    },
    plugins: {
