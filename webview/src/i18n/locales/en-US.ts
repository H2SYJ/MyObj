export default {
  ...
  settings: {
    ...
    tagDictionary: {
      title: 'Personal Tokenization Dictionary',
      navDescription: 'Manage custom words, stop words, and aliases',
      description:
        'Personal words and aliases override global rules, while stop words are combined. Saving hot-reloads the rules and rebuilds your historical files.',
      ruleCount: '{count} rules',
      previewTitle: 'Batch filename preview',
      previewDescription: 'Preview validates the current edits without saving or starting a rebuild',
      samplePlaceholder: 'One filename per line, up to 100 lines',
      rebuildQueued: 'The personal dictionary is active and {total} files were queued for rebuild',
      ...
      loadFailed: 'Failed to load the personal dictionary',
      saveSuccess: 'Personal dictionary hot-reloaded',
      saveFailed: 'Failed to save the personal dictionary',
      previewFailed: 'Dictionary preview failed'
    },
