export default {
  ...
  subscriptions: {
    ...
    modeDaily: 'Daily Time',
    modeCron: 'Cron Expression',
    cronPlaceholder: '0 */2 * * * * (sec min hour day month week); 5-field or @daily also accepted',
    cronInvalid: 'Invalid cron expression; it must have 5 or 6 fields (or an alias like @daily)',
